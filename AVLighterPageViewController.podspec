...
spec.source       = { :git => "https://github.com/angelvasa/AVLighterPageViewController.git", :tag => "0.4" }
spec.source_files = "AVLighterPageComponent", "AVLighterPageComponent/*.{swift}"
spec.platform = :ios
